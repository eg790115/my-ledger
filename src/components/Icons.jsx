...
export const SvgIcon = ({ name, size = 24, className = "" }) => {
  const icons = {
    ...
    history: <><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><path d="M9 12h6"/><path d="M9 16h6"/><path d="M9 8h6"/></>,
    ...
    cloudSync: <><path d="M4 14.899A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"/><path d="M12 12v9"/><path d="m8 17 4 4 4-4"/></>,
    bio: <><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></>,
