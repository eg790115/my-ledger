      ...
      {showSearchFilterModal && (
        <div className="bg-white rounded-[2rem] p-5 shadow-lg border border-blue-100 flex flex-col gap-4 animate-in slide-in-from-top-4 fade-in duration-300 relative overflow-hidden mt-2">
          ...
          <h4 className="font-black text-gray-800 text-sm pl-2 flex items-center gap-2">
            <SvgIcon name="search" size={16} className="text-blue-500" /> 進階篩選面板
          </h4>
          <div className="flex flex-col gap-3 pl-2">
            <div className="bg-gray-50 flex items-center p-2.5 rounded-xl border border-gray-100 focus-within:border-blue-300 transition-all">
            ...
            <div className="bg-gray-50 flex items-center p-2.5 rounded-xl border border-gray-100 focus-within:border-red-300 transition-all">
          ...
          <div className="flex gap-3 pl-2">
            <div className="flex-1 flex flex-col gap-1.5">
              ...
              <select value={historyTypeFilter} onChange={(e) => {triggerVibration(10); setHistoryTypeFilter(e.target.value);}} className="w-full bg-gray-50 border border-gray-100 rounded-xl py-3 px-3 text-xs font-black text-gray-800 outline-none focus:border-blue-300 appearance-none">
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              ...
              <select value={historyDateFilter} onChange={(e) => {triggerVibration(10); setHistoryDateFilter(e.target.value);}} className="w-full bg-gray-50 border border-gray-100 rounded-xl py-3 px-3 text-xs font-black text-blue-600 outline-none focus:border-blue-300 appearance-none">
          ...
          <div className="flex gap-3 pt-3 pl-2 mt-1 border-t border-gray-50">
            ...
            <button onClick={() => { triggerVibration(10); setShowSearchFilterModal(false); }} className="flex-1 py-3 bg-blue-50 text-blue-600 rounded-xl font-black text-xs active:scale-95 transition-transform flex items-center justify-center gap-1 border border-blue-100">收起面板 ▲</button>
          </div>
        </div>
      )}

      {/* 🌟 篩選條件標籤 */}
      {!showSearchFilterModal && isHistoryFiltered && (
